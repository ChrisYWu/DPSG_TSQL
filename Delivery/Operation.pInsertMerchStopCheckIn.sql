USE [Merch]
GO
/****** Object:  StoredProcedure [Operation].[pInsertMerchStopCheckIn]    Script Date: 9/24/2018 3:47:35 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN 
		...
		SET RouteID = @RouteID,
			...
			CheckInDistanceInMiles = dbo.udfDistanceInMiles(@StoreLat, @StoreLong, @CheckInLatitude, @CheckInLongitudee)
	...
	BEGIN 
		...
		CheckInLatitude, CheckInLongitude, DriveTimeInMinutes, StandardMileage, UserMileage, UTCInsertTime, UTCUpdateTime)
		VALUES (
		@DispatchDate, 
		...
		@ClientCheckInTimeZone,
		@CheckInLatitude, 
		@CheckInLongitude, @DriveTimeInMinutes, @StandardMileage, @UserMileage, SysUTCDateTime(), SysUTCDateTime())
